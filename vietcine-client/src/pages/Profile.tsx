...
export default function Profile() {
  ...
  const fetchBookingHistory = async () => {
    ...
    try {
      const response = await axios.get(
        `http://localhost:8081/api/bookings/user/${userContext?.id}`
      );
      if (response.data.success) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setErrorMessage(
          "Cập nhật thông tin thất bại: " + response.data.message
        );
      }
    } catch (error) {
          ...
          <div className="md:col-span-1">
            <div className="bg-gray-900 rounded-lg overflow-hidden shadow-lg">
              <div className="p-6 text-center">
                ...
                <p data-testid="user-email" className="text-gray-400 mb-4">
                  {user.email}
                </p>
              </div>
            </div>
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <p className="text-white" data-testid="email-display">
                            {user.email}
                          </p>
                        )}
                      </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-white" data-testid="phone-display">
                          {user.phone}
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-white" data-testid="address-display">
                    ...
                    {isEditing && (
                      <div className="pt-4 flex space-x-3">
                        <button
                          type="submit"
                          className={`flex items-center space-x-1 px-6 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition-colors ${
                            isUpdating ? "opacity-50 cursor-not-allowed" : ""
                          }`}
                          disabled={isUpdating}
