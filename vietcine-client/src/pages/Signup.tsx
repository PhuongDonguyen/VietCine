        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-start p-12 z-20">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-md">
              Khám phá thế giới điện ảnh đẳng cấp cùng những bộ phim đặc sắc
              nhất tại các rạp chiếu hàng đầu Việt Nam.
            </p>
          ...
          <div className="absolute bottom-0 left-0 right-0 h-8 bg-black opacity-80 flex">
            {[...Array(20)].map((_, i) => (
              <div
                key={i}
                className="h-full w-12 border-l border-r border-gray-700"
              ></div>
            ))}
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6 lg:p-8 bg-gray-900">
          <div className="w-full max-w-md space-y-8">
            ...
            <AuthForm isLogin={false} onToggleForm={navigateToLogin}>
              <input name="fullName" data-testid="signup-fullname-input" />
              <input name="email" data-testid="signup-email-input" />
              <input name="phone" data-testid="signup-phone-input" />
              <input name="address" data-testid="signup-address-input" />
              <input name="password" data-testid="signup-password-input" />
              <input
                name="confirmPassword"
                data-testid="signup-confirm-password-input"
              />
              <button type="submit" data-testid="signup-submit-btn">
                Đăng ký
              </button>
            </AuthForm>
          </div>
