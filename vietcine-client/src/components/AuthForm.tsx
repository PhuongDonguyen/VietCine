...
export function AuthForm({ isLogin, onToggleForm }: AuthFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                setFormError(response.data.message || "Đã xảy ra lỗi. Vui lòng thử lại.");
            }
        } catch (error) {
    ...
    return (
        <div className={isLogin ? "" : "w-full"}>
            <h2 className={`text-2xl font-bold text-white mb-6 ${isLogin ? "text-center" : "text-left"}`}>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                    <button
                        type="submit"
                        className={`w-full py-3 px-4 rounded-md font-medium text-white transition duration-300 ${isAnyLoading
            ...
            <div className="mt-6">
                ...
                <div className="mt-6 grid grid-cols-2 gap-3">
                    <button
                        ...
                        className={`w-full inline-flex justify-center py-2 px-4 border border-gray-700 rounded-md shadow-sm transition duration-300 ${googleAuthIsLoading
                    ...
                    <button
                        ...
                        className={`w-full inline-flex justify-center py-2 px-4 border border-gray-700 rounded-md shadow-sm transition duration-300 ${facebookIsLoading
                            ? "bg-gray-700 cursor-not-allowed text-gray-400"
                            : "bg-gray-800 text-gray-300 hover:bg-gray-700"
                            }`}
                    >
