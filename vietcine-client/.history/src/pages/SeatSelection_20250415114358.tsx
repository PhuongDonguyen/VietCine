...
export default function SeatSelection() {
    ...
    // Fetch showtime details, movie title, and booked seats
    useEffect(() => {
        const fetchShowtimeDetails = async () => {
            ...
            try {
                ...
                // Fetch movie title if not included in showtime response
                let movieTitle = showtimeData.movie?.title;
                if (!movieTitle) {
                    ...
                    movieTitle = movieResponse.data.data.data.title;
                }

                // Fetch booked seats
                const bookedSeatsResponse = await axios.get(
                    `http://localhost:8081/api/bookingseat/${showtimeId}/booked-seats`
                );
                if (!bookedSeatsResponse.data.success) {
                    throw new Error("Could not load booked seats");
                }

                const bookedSeatsData = bookedSeatsResponse.data.data;
                ...
                const formattedShowtime: Showtime = {
                    ...
                    totalSeats: showtimeData.screen.totalSeats,
                };
    ...
    const handleBackToShowtimes = () => {
        navigate(`/movie-detail/${movieId}`); // Adjust URL based on your routing
    };
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="flex-1">
                        <div className="bg-gray-900 rounded-lg p-6">
                            ...
                            <SeatMap
                                totalSeats={showtime.totalSeats} // Pass totalSeats to SeatMap
                                bookedSeats={bookedSeats} // Pass booked seats to SeatMap
