        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {movie.movieCasts.map((castItem, index) => (
                <div key={index} className="flex flex-col items-center">
                    <div className="w-24 h-24 mb-3 overflow-hidden rounded-full border-2 border-gray-800">
                        <img 
                    ...
                    <h4 className="font-medium text-center">{castItem.cast.name}</h4>
                    <p className="text-sm text-gray-400 text-center">vai {castItem.characterName}</p>
                </div>
            ))}
        </div>
    ) : (
