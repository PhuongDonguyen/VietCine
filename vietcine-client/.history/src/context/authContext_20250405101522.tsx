...
type AuthAction =
    | { type: "LOGIN"; payload: { user: User; token: string; role: string } }
    | { type: "LOGOUT" }
    | { type: "UPDATE"; payload: { user: User; token: string; role: string } };
...
export const AuthContextProvider = ({ children }: AuthContextProviderProps) => {
    ...
    useEffect(() => {
        try {
            const user = JSON.parse(localStorage.getItem("user") || "null") as Record<User, any> | null;
